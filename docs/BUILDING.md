...
For the project overview, screenshots, and controls, see the [README](../README.md).
...
`73db193f853e2ee079bf3ca8a64aa2eaf6459043`; see [GLAD2 provenance](../third_party/glad/PROVENANCE.md) for the exact
...
context, initializes particles on the GPU, renders three frames, checks OpenGL errors, and exits
automatically. This is a context/rendering check; it does not compare pixels or guarantee a moving
simulation substep during those three frames:
